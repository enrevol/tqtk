...
namespace k8asd
{
    public static class QuestCommand
    {
        ...
        /// </summary>
        public static async Task<Packet> RefreshListQuestAsync(this IPacketWriter writer)
        {
            return await writer.SendCommandAsync("44301");
        }
        ...
        public static async Task<Packet> GetStartOfQuestAsync(this IPacketWriter writer, int idQuest)
        {
            return await writer.SendCommandAsync("44201", idQuest.ToString());
        }
